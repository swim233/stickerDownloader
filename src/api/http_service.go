...
func RunHTTPServer(ctx context.Context) error {
	...
	mux.HandleFunc("/api/db/info", requireAuth(handleAPIDatabaseInfo))
	mux.HandleFunc("/api/db/export", requireAuth(handleAPIDatabaseExport))
	mux.HandleFunc("/api/db/import", requireAuth(handleAPIDatabaseImport))
