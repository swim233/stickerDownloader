...
func (l *BotLogger) log(level int, format string, v ...interface{}) {
	if level < l.logLevel {
		return
	}
	l.mutex.Lock()
...
func BotDebug(format string, v ...interface{}) {
	GetInstance().log(LevelDebug, format, v...)
}

func BotInfo(format string, v ...interface{}) {
	GetInstance().log(LevelInfo, format, v...)
}

func BotWarn(format string, v ...interface{}) {
	GetInstance().log(LevelWarn, format, v...)
}

func BotError(format string, v ...interface{}) {
